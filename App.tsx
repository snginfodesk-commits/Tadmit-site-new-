              ...
              <div className="container mx-auto px-6 max-w-6xl text-right">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                  {[
                    ...
                    {
                      icon: <Gem size={32} />,
                      title: 'איך לזהות עסקת יד 1 מצוינת',
                      desc: '5 הסימנים שמפרידים דירה רגילה מקבלן מעסקה שמייצרת רווח כבר ביום החתימה - מהיזם ועד המיקום והליווי הבנקאי.',
                      pages: 6,
                      slug: 'yad1-deal-signs',
                    },
                    {
                      icon: <Search size={32} />,
                      title: 'איך לזהות עסקת יד 2 מצוינת',
                      desc: '5 הסימנים לעסקת יד שנייה מתחת למחיר השוק עם פוטנציאל השבחה אמיתי - ואיך לבדוק אותם בעצמכם לפני שחותמים.',
                      pages: 6,
                      slug: 'yad2-deal-signs',
                    },
                    {
                      icon: <Handshake size={32} />,
                      title: '4 השאלות שכל זוג חייב לענות עליהן לפני שמדברים על כסף',
                      desc: 'מדריך קצר לזוגות שמסתדרים מצוין אבל תמיד מתחמקים מלדבר על כסף. אילו שאלות לשאול ואיך לגרום לשיח מקדם בין בני הזוג.',
                      pages: 7,
                      slug: 'couple-finance',
                    },
                  ].map((g, idx) => (
